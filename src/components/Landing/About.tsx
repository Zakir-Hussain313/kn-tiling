...
export default function About() {
  return (
    <main className="flex justify-center py-20 bg-[#e4f5ed]">
      <div className="w-[90%] lg:w-[80%]">
        ...
        <section className="block lg:hidden bg-white shadow-md rounded-md overflow-hidden">
          ...
          <div className="p-6 flex flex-col gap-4">
            <p className="font-semibold text-[#1a300d]">
        ...
        <section className="hidden lg:grid grid-cols-2 gap-0">
          ...
          <aside className="flex flex-col justify-center p-8 bg-white">
            <h1 className="font-bold text-4xl text-[#1a300d]">About Us</h1>
            <h2 className="font-bold text-3xl text-gray-900 mt-3">
              Sydney&apos;s Trusted Tiling Company
            </h2>
            <p className="font-semibold text-gray-700 mt-4 max-w-md">
          ...
          {/* Bottom-right text */}
          <aside className="flex flex-col justify-center p-8 bg-white">
            <p className="font-semibold text-gray-700 text-lg max-w-md">
              KN Tiling is a locally owned tiling company established in 2010. We provide
